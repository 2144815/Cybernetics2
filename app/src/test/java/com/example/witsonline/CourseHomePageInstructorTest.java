...
public class CourseHomePageInstructorTest {
    ...
    public void isLastItemDisplaying_empty() {
        CourseHomePageInstructor temp = new CourseHomePageInstructor();
        Boolean output=temp.isLastItemDisplaying(recyclerViewTest_Empty);
        assertEquals(false,output);
    }
    @Test
    public void isLastItemDisplaying_Nonempty() {
        CourseHomePageInstructor temp = new CourseHomePageInstructor();
        Boolean output=temp.isLastItemDisplaying(recyclerViewTest_NotEmpty);
